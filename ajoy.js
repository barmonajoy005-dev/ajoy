(function () {
  ...
  const _0x5e548e = {
    k: "https://raw.githubusercontent.com/barmonajoy005-dev/ajoy/refs/heads/main/key.txt",
    r: "https://raw.githubusercontent.com/barmonajoy005-dev/ajoy/refs/heads/main/get-ajoy.txt",
    t: "https://raw.githubusercontent.com/barmonajoy005-dev/ajoy/refs/heads/main/telegram.txt",
    x: "https://raw.githubusercontent.com/barmonajoy005-dev/ajoy/refs/heads/main/telegram2.txt",
  ...
  (async function () {
    ...
    _0xd9eed1.innerHTML = `
      <h3 style="margin:0 0 10px 0;color:#00ffcc;font-size:18px;letter-spacing:1px;font-weight:bold;">RAMA MODZ</h3>
      ...
      <button id="ajoy-telegram-btn"
        style="width:100%;background:#229ED9;color:#fff;border:none;padding:12px;border-radius:6px;font-weight:bold;cursor:pointer;font-size:13px;">CONTACT TELEGRAM  </button>
              <button id="shakil-telegram-btn"
        style="width:100%;background:#229ED9;color:#fff;border:none;padding:12px;border-radius:6px;font-weight:bold;cursor:pointer;font-size:13px;">CONTACT TELEGRAM </button>
    ...
    const _0xa73a22 = document.getElementById("ajoy-telegram-btn");
    const _0xa73a99 = document.getElementById("shakil-telegram-btn");
    ...
    _0xa73a99.addEventListener("click", async () => {
      try {
        const _0x3c4ae2 = await fetch(_0x5e548e.t + "?t=" + Date.now());
        const _0x5ca472 = (await _0x3c4ae2.text()).trim();
        if (_0x5ca472.startsWith("http")) {
    ...
    _0x115557.addEventListener("click", async () => {
      ...
      _0x115557.disabled = _0xa73a99.disabled = true;
      ...
      try { 
        ...
        if (_0x1b9391.includes(_0x485046)) {
          ...
          _0x115557.disabled = _0xa73a99.disabled = false;
        }
